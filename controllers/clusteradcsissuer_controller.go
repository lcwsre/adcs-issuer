...
import (
	...
	adcsv1 "github.com/lcwsre/adcs-issuer/api/v1"
)
...
// +kubebuilder:rbac:groups=adcs.certmanager.lcwsre.io,resources=clusteradcsissuers,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=adcs.certmanager.lcwsre.io,resources=clusteradcsissuers/status,verbs=get;update;patch

...
type AdcsRequestSpec struct {
	...
	// CertTemplate is the name of the ADCS certificate template to use.
	// This is read from the "cert-manager.io/cert-template" annotation on the Certificate.
	// If not set, the issuer's default template will be used.
	// +optional
	CertTemplate string `json:"certTemplate,omitempty"`
}
